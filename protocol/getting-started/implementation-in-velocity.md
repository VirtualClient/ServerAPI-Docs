---
description: This is an example implementation of the protocol in Velocity
---

# Implementation in Velocity
...
```java
proxyServer.getEventManager().register(plugin, PluginMessageEvent.class, event -> {
    if(event.getIdentifier().getId().equals("virtualclient:serverapi") && event.getSource() instanceof Player) {
        ...
        //You should probably run this if you want to make sure spigot servers recieve it too. 
